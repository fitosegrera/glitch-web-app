<script>
  import Interactive from "../../widgets/interactive.svelte";
  import BarScroller from "../../misc/bar-scroller.svelte";
...
<style>
  * {
  ...
  #wrapper {
    background: linear-gradient(-45deg, #000000, #121300, #010501, #03080a);
